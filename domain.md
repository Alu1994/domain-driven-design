...
Vale dizer que, <span style="background-color:red;font-weight:bold;">**não há problemas**</span> em ter um domínio anemico, principalmente se o projeto for simples ou que seu tempo para desenvolvimento seja breve, como um sistema pequeno que possua _CRUDs_ simples.
